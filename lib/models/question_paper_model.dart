...
class QuestionPaperModel {
  ...
  String timeInMinits() => "${((timeSeconds ?? 0) / 60).ceil()} mins";
...
class Answers {
  ...
  Answers.fromJson(QueryDocumentSnapshot<Map<String,dynamic>> snapshot) {
    identifier = snapshot['identifier'] as String?;
    answer = snapshot['Answer'] as String?;
  }
  Answers.fromSnapshot(Map<String, dynamic> json) {
