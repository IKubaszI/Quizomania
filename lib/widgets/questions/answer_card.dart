...
import 'package:fluuterek/configs/themes/app_colors.dart';  // Import AppColors
...
class AnswerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      borderRadius: UIParameters.cardBorderRadius,
      onTap: onTap,
      child: Container(  // Use Container to apply decoration
        decoration: BoxDecoration(
          borderRadius: UIParameters.cardBorderRadius,
        ...
        child: Ink(
          child: Text(
            answer,
            style: TextStyle(
              color: isSelected ? onSurfaceTextColor : null,  // Use the directly defined constant
            ),
          ),
        ),
      ),
